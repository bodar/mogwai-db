...
import { armBatches, assertsGType, collectionAssert, isLocalScope, PATH_LIST_OPS, typeOfAssert } from '../ir/step.ts';
...
import { isColumnArg, isNested, isPred, isTokenArg, argValues, arg, type Arg, type MergePolicy } from '../../gremlin/frontend.ts';
...
import { BULK, ENCOUNTER, NO_ALIASES, bodyOf, encounterOf, inBody, type ChainCtx, type Tail } from './lower/chain.ts';
...
import { branchSubject, bodyPredicate, childHostOf, childPredicate, sourceFilter } from './lower/filter.ts';
import { childSeam, foldedListSet, nestedFirstValue, pathSimplePredicate, perTraverserChild, reductionArm, rootedRead, rootedSteps, scalarChild, selfCollapses } from './lower/reduction.ts';

...
import {
    PAGERANK_SERVICE_NAME, WCC_SERVICE_NAME, PEER_PRESSURE_SERVICE_NAME, SHORTEST_PATH_SERVICE_NAME, HITS_SERVICE_NAME, CLOSENESS_SERVICE_NAME, HARMONIC_SERVICE_NAME,
} from '../spi/types.ts';

...
import { bagOf, bare, read, relOnly, run, runWith, seededStore } from '../support/harness.ts';
...
relOnly('a shared row op fails closed rather than answering a different question', () => {
  const store = seededStore();

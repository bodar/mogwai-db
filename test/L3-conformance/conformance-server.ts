...
const SEEDS: Record<string, Seed> = {
  ...
  // and would hang building quadrillions of rows. TRAVERSER BULKING (src/compiler/ir/bulk.ts,
...
export async function buildConformanceApp(graphs: readonly string[] = Object.keys(SEEDS)) {
  ...
  // configured with LabelCardinality.ZERO_OR_MORE" (LoadGraphWith.GraphData.ZOO) — and they now
  // simply agree with the rest rather than being provisioned differently.
  //

...
export class GremlinVisitor<Result> extends AbstractParseTreeVisitor<Result> {
    ...
    /**
     * Visit a parse tree produced by the `traversalSourceSpawnMethod_addV_Empty`
     * labeled alternative in `GremlinParser.traversalSourceSpawnMethod_addV`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitTraversalSourceSpawnMethod_addV_Empty?: (ctx: TraversalSourceSpawnMethod_addV_EmptyContext) => Result;
    /**
     * Visit a parse tree produced by the `traversalSourceSpawnMethod_addV_String`
     * labeled alternative in `GremlinParser.traversalSourceSpawnMethod_addV`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitTraversalSourceSpawnMethod_addV_String?: (ctx: TraversalSourceSpawnMethod_addV_StringContext) => Result;
    /**
     * Visit a parse tree produced by the `traversalSourceSpawnMethod_addV_Traversal`
     * labeled alternative in `GremlinParser.traversalSourceSpawnMethod_addV`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitTraversalSourceSpawnMethod_addV_Traversal?: (ctx: TraversalSourceSpawnMethod_addV_TraversalContext) => Result;
    /**
    ...
    /**
     * Visit a parse tree produced by `GremlinParser.traversalMethod_labels`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitTraversalMethod_labels?: (ctx: TraversalMethod_labelsContext) => Result;
    /**
     * Visit a parse tree produced by the `traversalMethod_addLabel_String`
     * labeled alternative in `GremlinParser.traversalMethod_addLabel`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitTraversalMethod_addLabel_String?: (ctx: TraversalMethod_addLabel_StringContext) => Result;
    /**
     * Visit a parse tree produced by the `traversalMethod_addLabel_Traversal`
     * labeled alternative in `GremlinParser.traversalMethod_addLabel`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitTraversalMethod_addLabel_Traversal?: (ctx: TraversalMethod_addLabel_TraversalContext) => Result;
    /**
     * Visit a parse tree produced by the `traversalMethod_dropLabels_Empty`
     * labeled alternative in `GremlinParser.traversalMethod_dropLabels`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitTraversalMethod_dropLabels_Empty?: (ctx: TraversalMethod_dropLabels_EmptyContext) => Result;
    /**
     * Visit a parse tree produced by the `traversalMethod_dropLabel_String`
     * labeled alternative in `GremlinParser.traversalMethod_dropLabel`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitTraversalMethod_dropLabel_String?: (ctx: TraversalMethod_dropLabel_StringContext) => Result;
    /**
     * Visit a parse tree produced by the `traversalMethod_dropLabel_Traversal`
     * labeled alternative in `GremlinParser.traversalMethod_dropLabel`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitTraversalMethod_dropLabel_Traversal?: (ctx: TraversalMethod_dropLabel_TraversalContext) => Result;
    /**
    ...
    /**
     * Visit a parse tree produced by `GremlinParser.stringArgumentVarargs`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitStringArgumentVarargs?: (ctx: StringArgumentVarargsContext) => Result;
    /**
    ...
    /**
     * Visit a parse tree produced by `GremlinParser.stringLiteralVarargs`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitStringLiteralVarargs?: (ctx: StringLiteralVarargsContext) => Result;
    /**

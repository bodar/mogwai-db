...
// that ONLY a real browser has — here, OpfsIoStore over real OPFS. It is deliberately outside test/ so
// the default `mise run ci` never launches a browser; run it with `mise run test:browser`.
describe('browser: OpfsIoStore over real OPFS', () => {
